...
class TeacherService {
  ...
  static async retrieveAllTeachers() {
    try {
      return await Teacher.getAllTeachers();
    } catch (error) {
      console.error('Error in TeacherService.retrieveAllTeachers:', error);
      throw error;
    }
  }

  static async retrieveRegisteredStudents() {
    try {
      return await Registration.getRegisteredStudents();
    } catch (error) {
      console.error('Error in TeacherService.retrieveRegisteredStudents:', error);
      throw error;
    }
  }
